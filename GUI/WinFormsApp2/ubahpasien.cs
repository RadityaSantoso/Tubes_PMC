...
{
    public partial class ubahpasien : Form
    {
        ...
        private void btnHapus_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Flag to check if patient was found and deleted
                ...
                using (StringWriter sw = new StringWriter())
                {
                    foreach (string line in lines)
                    {
                        ...
                        if (fields.Length >= 9 && fields[8].Trim() == idPasienToDelete)
                        {
                ...
                // Show success message if patient was found and deleted
                if (foundAndDeleted)
                {
